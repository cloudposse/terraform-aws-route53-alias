...
| parent_zone_id | ID of the hosted zone to contain this record  (or specify `parent_zone_id`) | string | `` | no |
| parent_zone_name | Name of the hosted zone to contain this record (or specify `parent_zone_name`) | string | `` | no |
