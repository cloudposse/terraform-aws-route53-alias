...
resource "aws_route53_record" "default" {
  ...
  #bridgecrew:skip=BC_AWS_GENERAL_95:All of the aliases are configurable via var.aliases and it is the user's responsibility to ensure that all of the resources are resources and not just IPv4 addresses.
